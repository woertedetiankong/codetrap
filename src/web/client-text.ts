export const WEB_TEXT = {
      en: {
        ...
        "prompt.learningGeneration": "Turn this source into study material. Explain it with an ASCII flow diagram and an easy-to-understand example. Show me the draft before saving it to Codetrap.",
      ...
      zh: {
        ...
        "prompt.learningGeneration": "帮我把这份资料整理成学习内容，用ASCII流程图结合通俗易懂的例子讲解。先给我审核，确认后再写入 Codetrap。",
