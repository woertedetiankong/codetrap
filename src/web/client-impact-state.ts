...
export interface ImpactState {
  ...
  impactEventFilter: string; impactView: "overview" | "runs" | "improve" | "evals";
  impactWorkbench: ImpactWorkbenchPayload | null; improvementId: string | null;
  impactRunQuery: string; impactRunFilter: "all" | "pending" | "attention";
...
export function createImpactState(): ImpactState {
  return { observationAvailability: "not_configured", observationOverview: null, observationHookHealth: null, observationConnection: null,
    ...
    impactWorkbench: null, improvementId: null, impactRunQuery: "", impactRunFilter: "all",
