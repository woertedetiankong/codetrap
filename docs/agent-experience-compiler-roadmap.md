...
| Learning workflow state and drafts | **Done** | 2026-09-05 | [handoff](tasks/2026-09-05-learning-workflow/handoff.md) | Source-scoped practice/proposal drafts, captured writes, preview version protection, guarded reads and authorization recovery pass 630 tests. Checkpointed after `d221695` at the user's request. |

### Closed decisions by date

- 2026-09-05 Learning workflow state now uses raw, versioned source-project/Insight drafts. Preview validates a submitted version without rewriting visible fields; submission stages an explicitly reviewed Candidate Inbox item. Durable draft recovery is a separate next slice; collection/filter presentation, Run choices and broader Impact typing remain open. See the [Learning workflow handoff](tasks/2026-09-05-learning-workflow/handoff.md).
