...
- The complete Observation/Evals stack and reliability hardening shipped in commit `4a66572` (`feat: add reliable observation and evals`). Local Hugging Face embeddings remained outside that commit.
