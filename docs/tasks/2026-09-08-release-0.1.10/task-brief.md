...
Publish codetrap 0.1.10 so other computers can install the interactive study feature.

## Success Criteria

Local release preflight, Linux/Windows CI and release workflows pass. npm latest
resolves to 0.1.10. A fresh isolated npm install reports the version and includes
